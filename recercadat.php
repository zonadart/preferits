...
<table id="main" border="0" cellpadding="0" cellspacing="0" width="70%">
  ...
  <tr>
      <td background="assets/body_main_header.gif" class="main">&nbsp;
        <div align="center"><span class="Estilo3">RECERCA DE DADES </span></div></td>
  </tr>
</tbody>
</table>
<table border="0" cellpadding="0" cellspacing="0" width="70%">
  <tbody><tr>
    <td width="560" align="center" valign="top">
	   <div align="left"><img src="imatges/body_main_header.gif" width="766" height="25" /><br>
	     <table width="766" border="0" cellpadding="4" cellspacing="0" style="border: 1px solid rgb(23, 23, 222);">
	       <tr>
	         <td><p align="center" class="italicsbold">&nbsp;</p>
		          <form action="llistadat.php" method="get" name="tip" target="_self" id="tip">
		            <label>
                    <div align="center">
